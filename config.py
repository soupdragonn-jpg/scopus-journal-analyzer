...
class Config:
    ...
    # Професионални титли
    PROFESSIONAL_TITLES = [
        'professor', 'dr.', 'phd', 'md', 'director', 'dean',
        'chair', 'head', 'chief', 'senior', 'associate', 'assistant'
    ]
    
    # Международни афилиации
    INTERNATIONAL_AFFILIATIONS = [
        'university', 'college', 'institute', 'hospital', 'research center',
        'academy', 'school', 'department', 'faculty', 'laboratory'
    ]
    
    # Peer review ключови думи
    PEER_REVIEW_KEYWORDS = [
        'peer review', 'double blind', 'single blind', 'open review',
        'referee', 'reviewer', 'review process', 'editorial review',
        'anonymous review', 'expert review'
    ]
